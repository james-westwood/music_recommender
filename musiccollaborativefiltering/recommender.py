...
if __name__ == "__main__":
    ...
    user_artists = load_user_artists(Path("data/hetrec2011-lastfm-2k/user_artists.dat"))

    # instantiate artist retriever
    artist_retriever = ArtistRetriever()
    artist_retriever.load_artists(Path("data/hetrec2011-lastfm-2k/artists.dat"))
